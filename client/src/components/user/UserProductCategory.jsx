import { Breadcrumb, Drawer, TextInput } from "flowbite-react";
...
export default function UserProductCategory() {
    ...
    useEffect(() => {
        if (category) {
            ...
            const initialCategories = { [category]: true };
            setCheckedCategory(initialCategories);

            // Trigger product fetch with the category
            ...
            // If no category, fetch all products and get data colors
